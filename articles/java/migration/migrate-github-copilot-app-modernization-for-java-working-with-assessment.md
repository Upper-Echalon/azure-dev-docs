...
java_zone_pivot_groups: ide-set-one
---
...
::: zone pivot="vscode"
[!INCLUDE [working-with-assessment-vscode](./includes/working-with-assessment-vscode)]
::: zone-end

::: zone pivot="intellij"
[!INCLUDE [working-with-assessment-intellij](./includes/working-with-assessment-intellij.md)]
::: zone-end
